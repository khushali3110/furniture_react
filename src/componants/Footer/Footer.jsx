...
<Typography sx={{mx : "2px"}} ><a href="https://github.com/AhmedSafwat97"  target="_blank" rel="noreferrer" style={{color : "yellow" ,textDecoration : "none"}}>khushali jikadra</a></Typography>           
